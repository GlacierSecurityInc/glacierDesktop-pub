...
I implemented the spellchecker from the electron documentation found here: https://www.electronjs.org/docs/latest/tutorial/spellchecker

One very important note, is that this change moves the context-menu implementation to the main process, so it is incompatible with
the changes made in #264, although it does address those changes.
### Added
